"""
Django settings for BDCasaHogar project.
...
SECRET_KEY = 'a9=!zyo2-!8iz_zs5xa53u=mv)p_q$t(b6%%65ec-bi2!d@8#l'
...
WSGI_APPLICATION = 'BDCasaHogar.wsgi.application'
